...
function ProfilePageClient({
  ...
  return (
    <div className="max-w-3xl mx-auto mt-32 mb-[5vh]">
      <div className="grid grid-cols-1 gap-6">
        <div className="w-full max-w-lg mx-auto">
          <Card className="bg-[hsl(var(--card))] border-[#6600ff]">
        ...
        <Tabs defaultValue="posts" className="w-full">
          <TabsList className="w-full justify-start border-b rounded-none h-auto p-0 bg-transparent border-[#6600ff]">
            <TabsTrigger
              value="posts"
